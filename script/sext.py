...
def sext_find(filename, rmsfile, outputname):
    filename = filename
    ...
    sew = sewpy.SEW(params=["X_IMAGE", "Y_IMAGE", "FLUX_RADIUS", "FLUX_MAX", "FLUXERR_ISO", "FLAGS",
                    ...
                    config={"DETECT_MINAREA": 60,
                            ...
                            "DEBLEND_NTHRESH": 32,
                            "CHECKIMAGE_NAME": outputname + '_check.fits',
...
sext_find('../data/abcd_006_lpf_new.fits',
          '../006_sex_test_check.fits', '006_sex_test')
sext_find('../data/rg_096.fits',
          '../data/rg_096_rms_100_1e-3_cubic.fits', '096_sex_test')
