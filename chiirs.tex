...
\label{sec:observations_and_data_reduction}
  ...
  We \moda{used} the VLA in \moda{its} A, CnB, and D configurations to observe the entire Sgr\,B2 complex in the frequency bands C (4--8~GHz). 
...
% \clearpage
  \subsection{Core size and emission measure} % (fold)
  ...
  \end{equation}
  Using $S_{6}$ and $S_{22}$ to solve Eq.~\ref{eq:s-tau} and Eq.~\ref{eq:tau-em}.

    \begin{figure}[ht]
          \begin{center}
          \includegraphics[width=0.4\textwidth]{./plot/R.pdf}
          \caption[RMS map of 6\,cm image.]{$r_{\rm calc}$ vs $r_{\rm obs}$ 
           }
  ...
  \begin{figure}[ht]
          ...
          \caption[RMS map of 6\,cm image.]{Distribution of EM.
           }
          \label{f:em_dist}
          \end{center}
  \end{figure}
    ...
    \begin{figure}[ht]
          ...
          \caption[RMS map of 6\,cm image.]{Distribution of $\dot{N}_{\rm Ly}$.
           }
          \label{f:nly_dist}
          \end{center}
  \end{figure}
  ...
  \subsection{Neutral gas density} % (fold)
  \label{sub:dustdensity}

  Extrapolate \hii SED to subtract free-free from $S_{96}$ to get $S_{\rm dust}$. Then:
    \begin{equation}
    \label{eq:dust_sed}
    S_{\rm dust} = \frac{2h\nu^3}{c^2}
    \frac{1}{e^{\frac{h\nu}{k_{\rm B}T_{\rm d}}}-1}
    ...
    \end{equation}
    \begin{equation}
      n_{\rm H_2} = 100\times\frac{3}{4}\frac{N_{\rm d}}{r}
    \end{equation}
  ...
  \end{figure}
    ...
    % \begin{equation}
    %   \frac{\dot{N}_{\rm Ly}}{\rm s^{-1}} = \frac{4}{3}
    % \end{equation}
    Calculate the initial Str\"{o}mgren radius $r_{\rm i}$.
    \begin{equation}
    ...
    \end{equation}
    where $c_{\rm i}$ is the sound speed ($\sim 10\, {\rm km\,s^{-1}}$).



      \begin{figure*}[ht]
          \begin{center}
          \includegraphics[width=0.85\textwidth]{./plot/time_distribution.pdf}
