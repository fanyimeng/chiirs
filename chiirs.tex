...
\label{sec:introduction}
  ...
  In this section, we present the image of SgrB2 in C band and the UCH{\sc ii} regions identified in it. We also compared between these ionized cores with dust cores idetified in 96~GHz. Statistics of the properties of these UCH{\sc ii} regions are shown.
